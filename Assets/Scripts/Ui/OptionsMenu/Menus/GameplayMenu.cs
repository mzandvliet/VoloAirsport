...
namespace RamjetAnvil.Volo.Ui {
    ...
    public class GameplayMenu : AbstractMenu {
        ...
        public override void Initialize(OptionsMenuModel model) {
            _settingsContainer.Initialize(GuiComponentDescriptor.FindDescriptors(model.GameplaySettings));
            _restoreDefaults.OnSubmit.AddListener(model.RestoreGameplayDefaults);
