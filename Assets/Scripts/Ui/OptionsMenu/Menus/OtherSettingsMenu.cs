...
namespace RamjetAnvil.Volo.Ui {
    ...
    public class OtherSettingsMenu : AbstractMenu {
        ...
        public override void Initialize(OptionsMenuModel model) {
            _settingsContainer.Initialize(GuiComponentDescriptor.FindDescriptors(model.OtherSettings));
            _restoreDefaults.OnSubmit.AddListener(model.RestoreOtherDefaults);
