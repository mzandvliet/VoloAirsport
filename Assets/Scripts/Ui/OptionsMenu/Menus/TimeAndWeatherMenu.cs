...
namespace RamjetAnvil.Volo.Ui {
    ...
    public class TimeAndWeatherMenu : AbstractMenu {
        ...
        public override void Initialize(OptionsMenuModel model) {
            _settingsContainer.Initialize(GuiComponentDescriptor.FindDescriptors(model.TimeAndWeatherSettings));
            _restoreDefaults.OnSubmit.AddListener(model.RestoreTimeAndWeatherDefaults);
        ...
        public override void SetState(OptionsMenuModel model, Func<string, string> l) {
            _title.text = l("time_and_weather");
        ...
        public override Menu Id {
            get { return Menu.TimeAndWeather; }
        }
    }
}
