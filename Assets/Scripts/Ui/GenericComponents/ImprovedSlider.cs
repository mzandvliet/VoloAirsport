...
namespace RamjetAnvil.Volo.Ui
{
    ...
    public class ImprovedSlider : Selectable, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
    {
        ...
        void UpdateDrag(PointerEventData eventData, Camera cam)
        {
            ...
            {
                //Vector2 localCursor;
                Vector2 localCursor = clickRect.InverseTransformPoint(eventData.pointerCurrentRaycast.worldPosition);
