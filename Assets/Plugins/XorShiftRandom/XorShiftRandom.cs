...
public class XorShiftRandom {
    ...
    const float REAL_UNIT_INT_S = 1.0f / ((float)int.MaxValue + 1.0f);
    const double REAL_UNIT_INT_D = 1.0 / ((double)int.MaxValue + 1.0);
    ...
    public int Next(int upperBound) {
        ...
        return (int)((REAL_UNIT_INT_D * (int)(0x7FFFFFFF & (w = (w ^ (w >> 19)) ^ (t ^ (t >> 8))))) * upperBound);
    }
    ...
    public int Next(int lowerBound, int upperBound) {
        ...
        return lowerBound + (int)((REAL_UNIT_INT_D * (double)(int)(0x7FFFFFFF & (w = (w ^ (w >> 19)) ^ (t ^ (t >> 8))))) * (double)range);
    }
    ...
    /// </summary>
    /// <returns></returns>
    /// <remarks>Added by Martijn, who doesn't *completely* understand the Xorshifter yet</remarks>
    public float NextSingle() {
        ...
        // System.Random.
        return (REAL_UNIT_INT_S * (int)(0x7FFFFFFF & (w = (w ^ (w >> 19)) ^ (t ^ (t >> 8)))));
    }
    ...
    public double NextDouble() {
        ...
        // Also note that the loss of one bit of precision is equivalent to what occurs within 
        // System.Random.
        return (REAL_UNIT_INT_D * (int)(0x7FFFFFFF & (w = (w ^ (w >> 19)) ^ (t ^ (t >> 8)))));
    }
